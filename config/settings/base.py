...
MILVUS_BGE_M3_BATCH_SIZE = int(env("MILVUS_BGE_M3_BATCH_SIZE", "16"))
MILVUS_BGE_M3_DEVICE = env("MILVUS_BGE_M3_DEVICE", "cpu")
MILVUS_BGE_M3_USE_FP16 = env_bool("MILVUS_BGE_M3_USE_FP16", False)
...
MILVUS_UPSERT_BATCH_SIZE = int(env("MILVUS_UPSERT_BATCH_SIZE", "128"))
...
VECTOR_INDEX_SCHEMA_VERSION = env("VECTOR_INDEX_SCHEMA_VERSION", "2026-03-fast-batch-v1")
...
VECTOR_INDEX_MAX_EMBED_TEXTS = int(env("VECTOR_INDEX_MAX_EMBED_TEXTS", "128"))
VECTOR_REINDEX_PUBLICATION_BATCH_SIZE = int(env("VECTOR_REINDEX_PUBLICATION_BATCH_SIZE", "24"))
